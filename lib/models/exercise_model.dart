...
dynamic _normalizeDynamicJsonValue(dynamic value) {
  if (value is Map) {
    return value.map(
      (key, val) => MapEntry(
        key.toString(),
        _normalizeDynamicJsonValue(val),
      ),
    );
  }
  if (value is List) {
    return value.map(_normalizeDynamicJsonValue).toList();
  }
  return value;
}
  ...
  factory ChoiceContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['options'] != null) {
      ...
      optionsList = options.map((option) {
        if (option is Map) {
          ...
          final optionMap = _normalizeStringDynamicMap(option);
    ...
    if (map['correctAnswers'] != null) {
      ...
      correctAnswersList = correctAnswers.map((answer) {
        if (answer is Map) {
          // Nếu là Map, lấy giá trị 'en' hoặc giá trị đầu tiên
          final answerMap = _normalizeStringDynamicMap(answer);
...
class FillBlankContent {
  ...
  factory FillBlankContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['text'] != null) {
      if (map['text'] is Map) {
        final textMap = _normalizeStringDynamicMap(map['text']);
    ...
    if (map['correctAnswers'] != null) {
      ...
      blanksList = (map['blanks'] as List<dynamic>)
          .map((e) => BlankItem.fromMap(_normalizeStringDynamicMap(e)))
          .toList();
    }
  ...
  factory BlankItem.fromMap(Map<String, dynamic> map) {
    ...
    if (map['correctAnswer'] != null) {
      if (map['correctAnswer'] is Map) {
        final answerMap = _normalizeStringDynamicMap(map['correctAnswer']);
    ...
    if (map['hints'] != null) {
      ...
      hintsList = hints.map((hint) {
        if (hint is Map) {
          final hintMap = _normalizeStringDynamicMap(hint);
...
class MatchingContent {
  ...
  String getRightItem(int index, String languageCode) {
    ...
    if (item is Map) {
      final itemMap = _normalizeStringDynamicMap(item);
  ...
  factory MatchingContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['rightItems'] != null) {
      ...
      rightItemsList = rightItems.map((item) {
        if (item is Map) {
          ...
          return _normalizeStringDynamicMap(item);
        }
    ...
    return MatchingContent(
      ...
      correctPairs: (map['correctPairs'] as List<dynamic>?)
              ?.map((e) => MatchingPair.fromMap(_normalizeStringDynamicMap(e)))
              .toList() ??
          [],
    );
  }
...
class MatchingPair {
  ...
  String getRight(String languageCode) {
    if (right is Map) {
      final rightMap = _normalizeStringDynamicMap(right);
  ...
  factory MatchingPair.fromMap(Map<String, dynamic> map) {
    ...
    if (map['left'] != null) {
      if (map['left'] is Map) {
        final leftMap = _normalizeStringDynamicMap(map['left']);
    ...
    if (map['right'] != null) {
      if (map['right'] is Map) {
        // Giữ nguyên Map để hỗ trợ multi-language
        rightValue = _normalizeStringDynamicMap(map['right']);
      } else {
        // Nếu là String, giữ nguyên
...
class CrosswordContent {
  ...
  factory CrosswordContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['words'] != null) {
      ...
      wordsList = wordsData
          .map((word) => CrosswordWord.fromMap(_normalizeStringDynamicMap(word)))
          .toList();
    }
...
class GroupQuestion {
  ...
  String? getExplanation(String languageCode) {
    ...
    if (explanation is Map<String, dynamic>) {
      final expMap = _normalizeStringDynamicMap(explanation);
      if (expMap.containsKey(languageCode)) {
  ...
  factory GroupQuestion.fromMap(Map<String, dynamic> map, {String? languageCode}) {
    ...
    dynamic content;
    final normalizedContent = _normalizeStringDynamicMap(map['content']);

    switch (type) {
      case ExerciseType.buttonSingleChoice:
        content = ButtonSingleChoiceContent.fromMap(normalizedContent);
        break;
      case ExerciseType.singleChoice:
      case ExerciseType.multipleChoice:
        content = ChoiceContent.fromMap(normalizedContent);
        break;
      case ExerciseType.fillBlank:
        content = FillBlankContent.fromMap(normalizedContent);
        break;
      case ExerciseType.crossword:
        content = CrosswordContent.fromMap(normalizedContent);
        break;
      default:
        content = null;
    }
    ...
    if (map['question'] != null) {
      if (map['question'] is Map<String, dynamic>) {
        final questionMap = _normalizeStringDynamicMap(map['question']);
  ...
  factory SpeakingContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['prompt'] != null) {
      if (map['prompt'] is Map) {
        final promptMap = _normalizeStringDynamicMap(map['prompt']);
    ...
    if (map['expectedKeywords'] != null) {
      ...
      keywordsList = keywords.map((keyword) {
        if (keyword is Map) {
          final keywordMap = _normalizeStringDynamicMap(keyword);
...
class WordMatchPair {
  ...
  String getDefinition(String languageCode) {
    ...
    if (definition is Map<String, dynamic>) {
      final defMap = _normalizeStringDynamicMap(definition);
      if (defMap.containsKey(languageCode)) {
  ...
  factory WordMatchPair.fromMap(Map<String, dynamic> map) {
    ...
    if (map['definition'] != null) {
      if (map['definition'] is Map) {
        definitionData = _normalizeStringDynamicMap(map['definition']);
      } else {
  ...
  factory WordMatchingContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['pairs'] != null) {
      pairsList = (map['pairs'] as List<dynamic>)
          .map((e) => WordMatchPair.fromMap(_normalizeStringDynamicMap(e)))
          .toList();
    }
...
class DefinitionMatchingContent {
  ...
  factory DefinitionMatchingContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['pairs'] != null) {
      pairsList = (map['pairs'] as List<dynamic>)
          .map((e) => DefinitionMatchPair.fromMap(_normalizeStringDynamicMap(e)))
          .toList();
    }
  ...
  factory WordFormationContent.fromMap(Map<String, dynamic> map) {
    ...
    if (map['sentence'] != null) {
      if (map['sentence'] is Map) {
        final sentenceMap = _normalizeStringDynamicMap(map['sentence']);
    ...
    if (map['explanation'] != null) {
      if (map['explanation'] is Map) {
        final explanationMap = _normalizeStringDynamicMap(map['explanation']);
...
class ExerciseModel {
  ...
  String getTitle(String languageCode) {
    ...
    if (title is Map<String, dynamic>) {
      final titleMap = _normalizeStringDynamicMap(title);
      if (titleMap.containsKey(languageCode)) {
  ...
  factory ExerciseModel.fromFirestore(
    ...
    final normalizedData = _normalizeStringDynamicMap(data);
    final type =
        ExerciseType.fromString(normalizedData['type'] ?? 'single_choice');
    dynamic content;

    switch (type) {
      case ExerciseType.singleChoice:
      case ExerciseType.multipleChoice:
        content = ChoiceContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.fillBlank:
        content = FillBlankContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.matching:
        content = MatchingContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.listening:
        content = ListeningContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.speaking:
        content = SpeakingContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.buttonSingleChoice:
        content = ButtonSingleChoiceContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.crossword:
        content = CrosswordContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      ...
      case ExerciseType.wordMatching:
        content = WordMatchingContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.definitionMatching:
        content = DefinitionMatchingContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.wordFormationExercise:
        content = WordFormationContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
      case ExerciseType.wordPatternExercise:
        content = WordPatternContent.fromMap(
          _normalizeStringDynamicMap(normalizedData['content']),
        );
        break;
    }
    ...
    if (normalizedData['groupQuestions'] is List) {
      final groupQuestionsList =
          normalizedData['groupQuestions'] as List<dynamic>;
      groupQuestionsData = groupQuestionsList
          .map(
            (e) => GroupQuestion.fromMap(
              _normalizeStringDynamicMap(e),
    ...
    if (normalizedData['speakerVoices'] != null) {
      final speakerVoicesMap =
          _normalizeStringDynamicMap(normalizedData['speakerVoices']);
      speakerVoicesData = speakerVoicesMap.map(
        (key, value) => MapEntry(
          key,
          VoiceConfig.fromMap(_normalizeStringDynamicMap(value)),
        ),
      );
    }
    ...
    if (normalizedData['defaultVoice'] != null) {
      defaultVoiceData = VoiceConfig.fromMap(
        _normalizeStringDynamicMap(normalizedData['defaultVoice']),
      );
    }
    ...
    String questionText = '';
    if (normalizedData['question'] != null) {
      if (normalizedData['question'] is Map) {
        final questionMap =
            _normalizeStringDynamicMap(normalizedData['question']);
        // Ưu tiên lấy theo language đã chọn, nếu không có thì fallback sang 'en'
        if (languageCode != null && questionMap.containsKey(languageCode)) {
          questionText = questionMap[languageCode].toString();
        } else {
        ...
        questionText = normalizedData['question'].toString();
      }
    }
    ...
    // Ưu tiên lấy theo language đã chọn, nếu không có thì fallback sang 'en'
    String? explanationText;
    if (normalizedData['explanation'] != null) {
      if (normalizedData['explanation'] is Map) {
        final explanationMap =
            _normalizeStringDynamicMap(normalizedData['explanation']);
        // Ưu tiên lấy theo language đã chọn, nếu không có thì fallback sang 'en'
        ...
        explanationText = normalizedData['explanation'].toString();
      }
    }
    ...
    if (normalizedData['title'] != null) {
      if (normalizedData['title'] is Map) {
        titleData = _normalizeStringDynamicMap(normalizedData['title']);
      } else {
        titleData = {'en': normalizedData['title'].toString()};
      }
    }
    ...
    return ExerciseModel(
      ...
      unitId: normalizedData['unitId'] ?? '',
      levelId: normalizedData['levelId'] ?? '',
      skillTypes: _stringListFrom(normalizedData['skillTypes']),
      grammarTopics: _stringListFrom(normalizedData['grammarTopics']),
      type: type,
      question: questionText,
      content: content,
      points: normalizedData['points'] ?? 10,
      timeLimit: normalizedData['timeLimit'],
      difficulty: Difficulty.fromString(normalizedData['difficulty'] ?? 'easy'),
      explanation: explanationText,
